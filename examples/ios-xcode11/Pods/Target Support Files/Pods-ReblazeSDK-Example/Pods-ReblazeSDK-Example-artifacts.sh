...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Reblaze/libs/iOS/ReblazeSDK.xcframework" "" "true" "ios-arm64_i386_x86_64-simulator/ReblazeSDK.framework" "ios-arm64_armv7/ReblazeSDK.framework"
fi
